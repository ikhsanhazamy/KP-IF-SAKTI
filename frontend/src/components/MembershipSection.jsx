    ...
    <section className="bg-[#f6f8f7] px-4 sm:px-8 lg:px-20 py-12 sm:py-16 lg:py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 items-center">
        ...
        <div className="relative flex justify-center">
          ...
          {/* BADGE */}
          <div className="absolute -top-5 right-4 sm:right-14 bg-white shadow-md rounded-xl px-4 py-2 flex items-center gap-2 z-10">
          ...
          {/* CARD */}
          <div className="w-full max-w-[592px] h-[320px] sm:h-[392px] rounded-2xl overflow-hidden relative shadow-lg text-white">
            ...
            <div className="relative z-10 h-full px-6 sm:px-8 py-6 sm:py-7 flex flex-col justify-between">
              ...
              <div>
                ...
                <h3 className="text-xl sm:text-2xl font-semibold mt-1">FATAYAT NU</h3>
              ...
              <div className="space-y-4 text-left">
                ...
                <div>
                  ...
                  <p className="text-base sm:text-lg font-semibold">Siti Nurhaliza, S.Pd</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-y-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium text-sm sm:text-base">FN-SKB-2024-1234</p>
                  </div>
                  <div>
                    <p className="opacity-70">PAC</p>
                    <p className="font-medium text-sm sm:text-base">Cibadak</p>
                  </div>
                  <div>
                    <p className="opacity-70">Berlaku Hingga</p>
                    <p className="font-medium text-sm sm:text-base">31 Desember 2026</p>
                  </div>
                </div>
              ...
              {/* QR */}
              <div className="absolute bottom-6 right-6 w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-xl flex items-center justify-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* ITEM */}
          <div className="bg-white rounded-xl p-5 border border-gray-200 flex gap-4 items-center min-h-[100px]">
            <div className="w-12 h-12 bg-[#eef3f0] rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-200 flex gap-4 items-center min-h-[100px]">
            <div className="w-14 h-14 bg-[#eef3f0] rounded-xl flex items-center justify-center flex-shrink-0">
              📊
            </div>
            <div>
