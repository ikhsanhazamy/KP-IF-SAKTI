...
function Hero() {
  return (
    <section className="bg-gradient-to-r from-primary-500 to-primary-600 px-4 sm:px-8 lg:px-20 py-12 sm:py-16 lg:py-20 flex flex-col lg:flex-row items-center justify-between text-white gap-12 lg:gap-0">
      ...
      <div className="max-w-2xl w-full text-center lg:text-left">
        ...
        <h1 className="text-[40px] sm:text-[52px] lg:text-[64px] font-semibold leading-[1.1] mt-6 text-gray-900">
          Memberdayakan{" "}
          <span className="text-[#1f7a4d]">Perempuan</span> <br />
          Melalui Organisasi Digital
        </h1>

        <p className="text-gray-500 mt-6 text-base sm:text-lg max-w-xl mx-auto lg:mx-0">
        ...
        {/* STATS */}
        <div className="flex flex-wrap gap-8 sm:gap-12 lg:gap-16 mt-12 justify-center lg:justify-start">
          <div>
      ...
      {/* RIGHT */}
      <div className="relative w-full max-w-[580px] mx-auto lg:mx-0 flex-shrink-0">

        <img
          src={image1}
          alt="hero"
          className="w-full h-[320px] sm:h-[400px] lg:h-[500px] object-cover rounded-2xl shadow-xl"
        />

        {/* FLOAT CARD */}
        <div className="absolute -bottom-10 -left-4 sm:-left-10 bg-white px-4 sm:px-6 py-4 rounded-xl shadow-xl flex items-center gap-4">
          {/* ICON */}
